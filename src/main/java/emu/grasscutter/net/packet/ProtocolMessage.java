...
public abstract class ProtocolMessage {
    ...
    protected static void setField(
        ...
        // If null then it might not exist in this game version or there is a spelling mistake in either
        // the OuterClass
        // or the proto interface
    }

    protected static Object getField(
            Message messageBuilder, Descriptors.Descriptor descriptor, String name) {
        Descriptors.FieldDescriptor fieldDescriptor = descriptor.findFieldByName(name);
